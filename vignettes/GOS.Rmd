...
![plot of chunk bestkappa1](man/figs/bestkappa1-1.png)
...
![**Figure 1**. Processes of determining the optimal similarity. (a) The optional `kappa` is (0.01, 0.05, 0.1, 0.2, 0.5, 1) and `nrepeat` is 2. (b) The optional `kappa` is (0.01, 0.02, ..., 0.09, 0.1, 0.2, ..., 1) and `nrepeat` is 10.](man/figs/bestkappa-1.png)

*The default ratio of training set to test set in `gos_bestkappa()` is 1:1. You can specify the ratio of training set to test set by `nsplit` parameter*
...
![**Figure 2**. Geographially optimal similarity (GOS)-based prediction (a) and uncertainty (b).](man/figs/gos_result-1.png)
...
![**Figure 3**. Geographially optimal similarity (GOS)-based spatial prediction uncertainties under different $\zeta$ values.](man/figs/uncertainty-1.png)
