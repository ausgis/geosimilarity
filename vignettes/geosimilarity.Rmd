...
```{r bestkappa2, fig.width=7.5,fig.height=7.5,fig.cap="**Figure 1**. Processes of determining the optimal similarity. (a) The optional `kappa` is (0.01, 0.05, 0.1, 0.2, 0.5, 1) and `nrepeat` is 2. (b) The optional `kappa` is (0.01, 0.02, ..., 0.09, 0.1, 0.2, ..., 1) and `nrepeat` is 10."}
system.time({
...
```{r gos_result,fig.width=9.5,fig.height=3.5,fig.cap="**Figure 2**. Geographially optimal similarity (GOS)-based prediction (a) and uncertainty (b)."}
system.time({
...
```{r uncertainty, fig.width=9.5,fig.height=7,fig.cap="**Figure 3**. Geographially optimal similarity (GOS)-based spatial prediction uncertainties under different $\zeta$ values."}
uc <- g2 %>% 
